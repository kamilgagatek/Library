...
<body>
    ...
    <div id="top">
        <p id="top-writing">Najlepsza biblioteka</p>
        <span class="creation-date">od 2008 roku</span>
    </div>
        <a href="#middle"><img src="./arrow.png" id="arrow" alt="Strzałka"></img></a>
    <div id="middle">
        <div id="mid1">
        ...
        <div id="mid2">
            <?php
                ...
                photo_name FROM books ORDER BY add_date DESC LIMIT 3");
                    while($row = mysqli_fetch_array($question))
                        { echo "
                            <div class='container'>
                                <div id='container1'>
                                <img src='{$row['photo_name']}' class='book-img'>
                                </img></div>
                                <div id='container2'><p>{$row['book_name']}</p></div>
                            </div>";
                        }
                $connect -> close();
            ?>
    ...
    <div id="bottom">
            ...
            while($row = mysqli_fetch_array($question3))
            {
                $top_client=$row['client_id'];
                    $question3 = $connect -> query("SELECT name, surname
